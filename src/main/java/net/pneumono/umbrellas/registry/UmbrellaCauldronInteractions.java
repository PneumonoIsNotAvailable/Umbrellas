...
public class UmbrellaCauldronInteractions {
    ...
    public static void registerCauldronBehavior() {
        ...
        for (Item item : washableUmbrellas) {
            //? if >=26.1 {
            CauldronInteractions.WATER.put(item, UmbrellaCauldronInteractions::cleanUmbrella);
            //?} else if >=1.21 {
            /*CauldronInteraction.WATER.map().put(item, UmbrellaCauldronInteractions::cleanUmbrella);
            *///?} else {
            /*CauldronInteraction.WATER.put(item, UmbrellaCauldronInteractions::cleanUmbrella);
            *///?}
        }
    }
}
