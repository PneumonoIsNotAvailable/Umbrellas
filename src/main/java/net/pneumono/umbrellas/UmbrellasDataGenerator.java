...
public class UmbrellasDataGenerator implements DataGeneratorEntrypoint {
    ...
    private static class AdvancementsGenerator extends FabricAdvancementProvider {
        ...
        public static ItemPredicate getTagPredicate(TagKey<Item> tagKey) {
            return new ItemPredicate(tagKey, null, NumberRange.IntRange.ANY, NumberRange.IntRange.ANY, new EnchantmentPredicate[0], new EnchantmentPredicate[0], null, new NbtPredicate(null));
        }

        public static ItemPredicate getEnchantmentPredicate(EnchantmentPredicate enchantment) {
            return new ItemPredicate(null, null, NumberRange.IntRange.ANY, NumberRange.IntRange.ANY, new EnchantmentPredicate[]{enchantment}, new EnchantmentPredicate[0], null, new NbtPredicate(null));
        }
    }
}
