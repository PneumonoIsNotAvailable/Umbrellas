...
public class UmbrellaPatterns {
    protected static void registerPatterns() {
    ...
    private static void registerPattern(String name, boolean colored) {
        Registry.register(PatternRegistry.UMBRELLA_PATTERN, new Identifier(Umbrellas.MOD_ID, name), new UmbrellaPattern(name, colored));
    }
}
